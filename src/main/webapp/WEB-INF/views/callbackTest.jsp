...
<div class="agree" style="overflow:scroll; width:50%; height:200px;">
...
<script>
	...
	/* var naver_id_login = new naver_id_login("dnvfDSWWZdZLlC4W0n7E", "http://localhost:8080/icade/callbackTest");
		...
		function naverSignInCallback() {
		  ...
		  alert(naver_id_login.getProfileData('id')); //19387775
		} */
/* 
	$(document).ready(function (){
		var id = Math.floor(Math.random() * 1000000000) + 1;
		$("#id").val(result);
		$("#sns_id").val(naver_id_login.getProfileData('id'));
	...
	window.addEventListener('load', function () {
		naverLogin.getLoginStatus(function (status) {
			if (status) {
				...
				var snsDTO = new Object();
				snsDTO.id = id;
				snsDTO.email = email;
				snsDTO.name = name;
				snsDTO.sns_id = sns_id;
