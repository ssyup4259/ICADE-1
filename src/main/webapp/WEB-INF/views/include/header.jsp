	...
	<ul>
		...
		<c:if test="${sessionScope.userInfo.getM_RANK() == 'admin'}">
			<li class="dropdown" style="float: right;">
				...
				<div class="dropdown-content">
					<a href="">공지사항 등록</a> <a href="<%=cp%>/admin/goodsList.action">관리자 상품 목록</a> <a href="<%=cp%>/admin/memberList.action">회원 목록</a> <a href="<%=cp%>/admin/payments.action">회원 결제 내역</a> <a href="<%=cp%>/logout.action">로그아웃</a>
				</div>
			</li>
		</c:if>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				&nbsp;<a href="<%=cp%>/faq.action"> FAQ</a>&nbsp;&nbsp;<a href="">고객센터</a>&nbsp;&nbsp;<a href="<%=cp%>/faq.action">공지사항</a>
			</div>
