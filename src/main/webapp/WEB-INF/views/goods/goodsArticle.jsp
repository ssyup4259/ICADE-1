				...
				<div class="row">
					...
					<div class="col-sm-7" style="font-size: 20px;">
						...
						<div class="row" style="height: 60px;">
							...
							<div class="col-sm-9" style="text-align: left">
							<img src="<%=cp%>/resources/images/countDown.png" onclick="countDown();" style="width: 30px; height: 30px; vertical-align: middle; cursor: pointer;">
							<!-- 	<input type="button" id="down" class="down" onclick="countDown();" /> -->
								...
								<img src="<%=cp%>/resources/images/countUp.png" onclick="countUp();" style="width: 30px; height: 30px; vertical-align: middle; cursor: pointer;">
							</div>
						</div>
						<div class="row" style="height: 60px;">
