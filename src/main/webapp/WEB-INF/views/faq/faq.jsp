...
<jsp:include page="../include/header.jsp" flush="false" />
	<div align="left">
		<font size="8">FAQ:자주묻는질문 답변</font>
	</div>
	    ...
	    <ul>
		    <li class="" style="text-align: left">
		        <a href="#answer9" onclick="faqMove(9);"><font style="font-size: 13"> 1. 적립금</font></a>
		      	<ul id="answer9">
		             <li class="">
 				출석체크 , 더 러너(모바일게임) , 결제금액 , 이벤트, 포토리뷰작성 등을 통해 적립이 가능하며, 5000원이상 적립금부터 사용이가능합니다.
		             </li>   
		        </ul>
		      </li>
	     </ul>
	      <ul>
		    <li class="" style="text-align: left">
		        <a href="#answer10" onclick="faqMove(10);"><font style="font-size: 13">2. 회원혜택</font></a>
		      	<ul id="answer10">
		             <li class="" style="font-size: 13">
		 				[silver] 첫 회원가입시 적용, 구매금액의 10%가 적립금으로 적립이 됩니다.<br>
						[gold] 실결제금액 5만원이상 누적시,평생무료배송+15%구매금액 적립금+2%모든제품할인 으로 업그레이 됩니다.<br>
						[platinum] 실결제금액 30만원이상 누적시,평생무료배송+15%구매금액 적립금+5%모든제품할인 으로 업그레이 됩니다.<br>
						[diamond] 실결제금액 50만원이상 누적시,평생무료배송+18%구매금액 적립금+10%모든제품할인 으로 업그레이 됩니다.<br>
		             </li>   
		        </ul>
		      </li>
	     </ul>
	    </div>
	    <div>5th Contents</div>
	</div>
