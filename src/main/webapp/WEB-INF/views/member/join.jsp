	...
	<form name="joinForm" action="" method="post" id="joinForm">
		<div class="container text-center">
			...
			<div class="col-sm-8">
				<div class="row">
					...
					<div class="col-sm-8" style="text-align: left;">
						<input type="text" id="user_Id" placeholder="아이디 : 8글자이상 입력하세요" name="M_ID" value="" maxlength="30" size="10" style="padding-left: 10px; width: 100%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px; webkit-ime-mode: disabled" />
						<br>
					...
					<div class="col-sm-2">
						<input type="button" value="중복확인" style="width: 120px;" class="btn" id="user_id_checkBtn" />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-10" style="text-align: left;">
						<input type="text" placeholder="이름 : Ex)박명성" name="M_NAME" id="name" maxlength="10" size="15" style="padding-left: 10px; width: 100%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-8" style="text-align: left;">
						<input type="text" id="user_NickName" placeholder="닉네임 : 2글자 이상 입력하세요" name="M_NICKNAME" maxlength="30" size="15" style="padding-left: 10px; width: 100%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
						<br>
				...
				<div class="row">
					...
					<div class="col-sm-4" style="text-align: left;">
						<input type="text" placeholder="이메일 : Ex)444" id="email1" name="M_EMAIL_ID" maxlength="30" size="15" style="padding-left: 10px; width: 100%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
						<br>
					...
					<div class="col-sm-4">
						<input id="email2" name="M_EMAIL_DOMAIN" placeholder="이메일 : Ex)naver.com" maxlength="30" style="width: 100%; height: 40px" size="15" type="text" />
				...
				<div class="row">
					...
					<div class="col-sm-10" style="text-align: left;">
						<input type="text" id="t1" placeholder="전화번호 : ex)010" name="M_CELLPHONE1" maxlength="30" size="15" style="padding-left: 10px; width: 23%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
						-
						<input type="text" id="t2" placeholder="전화번호 : Ex)0000" name="M_CELLPHONE2" maxlength="30" size="15" style="padding-left: 10px; width: 35%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
						-
						<input type="text" id="t3" placeholder="전화번호 : Ex)1234" name="M_CELLPHONE3" maxlength="30" size="15" style="padding-left: 10px; width: 35%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px" />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-8" style="text-align: left">
						<input type="text" name="M_ZIPCODE" readonly="readonly" class="form-control" placeholder="우편번호" id="sample6_postcode" style="padding-left: 10px; width: 28%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px">
						<input type="text" name="M_ADDRESS1" class="form-control" placeholder="주소" id="sample6_address" style="padding-left: 10px; width: 70%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px">
					</div>
					<div class="col-sm-2">
				...
				<div class="row">
					<div class="col-sm-2"></div>
					<div class="col-sm-10" style="text-align: left">
						<input type="text" name="M_ADDRESS2" class="form-control" placeholder="상세주소" id="sample6_address2" style="padding-left: 10px; width: 100%; height: 40px; background-color: transparent; color: #5c8a8a; font-family: 'Do Hyeon', sans-serif; font-size: 16px">
					</div>
				</div>
				<div class="row"></div>
			</div>
			...
			<div style="text-align: center; padding-bottom: 15px;">
				<input type="button" class="btn" id="singUpBtn" value="회원가입" style="width: 200px; height: 40px;" onclick="" />
