			...
			<div id="contents">
	            ...
	            <select id="order_status" name="order_status" class="">
					...
					<option value="order_return">반품</option>
							...
							<span class="period">
								<a href="#none" class="btnNormal" days="00"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date1_on.gif" id="today" alt="오늘"></a> <a href="#none" class="btnNormal" days="07"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date2.gif" id="oneWeek" alt="1주일"></a> <a href="#none" class="btnNormal" days="30"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date3.gif" id="oneMonth" alt="1개월"></a> <a href="#none" class="btnNormal" days="90"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date4.gif" id="threeMonth" alt="3개월"></a> <a href="#none" class="btnNormal" days="180"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date5.gif" id="sixMonth" alt="6개월"></a>
							</span>
							<!-- 기간 지정부분 -->
	        	...
	        	<button type="button" class="ui-datepicker-trigger" ><img src="//img.echosting.cafe24.com/skin/admin_ko_KR/myshop/ico_cal.gif" alt="..." title="..."></button> -->
							...
							<input type="text" id="sdate" name="startDay">
							~
							<input type="text" id="edate" name="endDay">
							...
							<c:forEach var="map" items="${hashMap}">
								<c:forEach var="dto" items="${map.value }">
									<tr class="xans-record-">
										...
										<td class="thumb"><a href="/icade/goods/goodsArticle.action?G_NUM=${dto.getGD_NUM()}"> <img src="/icade/resources/goodsImage/${dto.getG_SAVEFILENAME()}" width="80" height="80">
										</a></td>
										<td class="product left top"><a href="/icade/goods/goodsArticle.action?G_NUM=${dto.getGD_NUM()}"> <strong>${dto.getOD_NAME()}</strong>
										</a>
											<div class="option ">[옵션: ${dto.getOD_NAME()}-${dto.getOD_DEVICE()}-${dto.getOD_COLOR()}]</div></td>

										<td>${dto.getOD_COUNT()}</td>

										<td class="right"><strong><fmt:formatNumber>${dto.getOD_PRICE()}</fmt:formatNumber>원</strong></td>

										<td class="state">
											<p class="txtEm">${dto.getO_STATUS()}</p>
										</td>

										<td><a href="#none" class="line" onclick="location.href='ordersHistoryDetail.action?o_num=${dto.getO_NUM()}'">[상세정보]</a>
											<p class="">${dto.getO_IMP()}</p></td>
